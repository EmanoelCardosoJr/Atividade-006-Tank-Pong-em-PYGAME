...
tank2_rect = pygame.Rect(
    Tank.tank2_x, Tank.tank2_y, Tank.tank_size, Tank.tank_size
)
...
while True:
    ...
    if conf.shoot:
        conf.ball_mx, conf.ball_my = ball.shoot(
            ball1,
            tank_sprite,
            Tank.tank1_x + 25 / 2,
            Tank.tank1_y + 28 / 2,
    ...
    if conf.hit:
        ...
        conf.hit = False
    if conf.shoot2:
        conf.ball2_mx, conf.ball2_my = ball.shoot(
            ball2,
            tank2_sprite,
            Tank.tank2_x + 25 / 2,
            Tank.tank2_y + 28 / 2,
